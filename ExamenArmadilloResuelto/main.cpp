...
//Instancia un nuevo espacio de memoria en el
//heap y le asigna a (dado), luego devuelve
...
//Asigna b (dado) a la direccion de memoria
//donde apunta a (dado)
...
//Escribe valor (dado) en un archivo
//con nombre nombre_archivo (dado)
template<typename T>
...
//Devuelve el valor almacenado en el archivo
//con nombre nombre_archivo (dado)
template<typename T>
...
//        i++)
//    {
//        arreglo[pos_actual]=*i;
//        pos_actual++;
//    }
    list<int>::iterator i = lista.begin();
    for(int pos_actual = 0;
        pos_actual<lista.size();
        pos_actual++)
    {
        arreglo[pos_actual]=*i;
        i++;
...
//Devuelve un vector ordenado de menor a mayor que contenga todo
//el contenido de v1 (dado) y v2 (dado).
...
//    int i1=0;
//    int i2=0;
//    int tamano_final=v1.size()+v2.size();
//
//    for(int j=0;j<tamano_final;j++)
//    {
//        if(v1[i1]<v2[i2])
//        {
//            respuesta.push_back(v1[i1]);
//            i1++;
//            if(i1==v1.size())
//            {
//                for(;i2<v2.size();i2++)
//                {
//                    respuesta.push_back(v2[i2]);
//                }
//                return respuesta;
//            }
//        }else
...
vector<int> mezclarOrdenadamente(vector<int>v1,vector<int>v2)
{
    ...
    for(int i=0;i<respuesta.size()-1;i++)
    {
        ...
        {
            if(respuesta[menor]>respuesta[j])
            {
                menor=j;
            }
        }
        int temp=respuesta[menor];
        respuesta[menor]=respuesta[i];
        respuesta[i]=temp;
    }
